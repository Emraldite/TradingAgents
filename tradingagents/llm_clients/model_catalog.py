...
MODEL_OPTIONS: ProviderModeOptions = {
    ...
    "google": {
        "quick": [
            ("Gemini 3.1 Flash Lite - Free-tier routine analysis (GA)", "gemini-3.1-flash-lite"),
            ("Gemini 3.5 Flash - Free-tier intelligent speed", "gemini-3.5-flash"),
        ...
        "deep": [
            ("Gemini 3.5 Flash - Free-tier intelligent speed", "gemini-3.5-flash"),
            ("Gemini 3.1 Flash Lite - Free-tier fallback (GA)", "gemini-3.1-flash-lite"),
