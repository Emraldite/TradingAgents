...
- 2026-07-09: Fixed CLI import cost by lazy-loading LangGraph/analysis-only imports so lightweight commands like `walk-forward` do not load the full AI graph stack at import time.
